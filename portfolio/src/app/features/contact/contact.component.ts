  ...
  readonly socialLinks: SocialLink[] = [
    {
      ...
      color: '#0A66C2',
      icon: 'in',
      hintKey: 'contact.social.linkedin',
    },
    {
      name: 'GitHub',
    ...
    },
    {
      ...
      color: '#f0f0f0',
      icon: 'X',
      hintKey: 'contact.social.twitter',
    },
    {
      name: 'WhatsApp',
      url: 'https://wa.me/5212841046682',
      color: '#25D366',
      icon: '',
      ...
      hintKey: 'contact.social.whatsapp',
    },
    {
      name: 'Email',
